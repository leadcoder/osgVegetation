...
namespace osgVegetation
{
	...
	public:
		...
		static osg::Node* CreateTerrainGeomFromTerrainTile(osgTerrain::TerrainTile* tile)
		{
			osg::Node* node = NULL;
			osgTerrain::HeightFieldLayer* layer = dynamic_cast<osgTerrain::HeightFieldLayer*>(tile->getElevationLayer());
			if (layer)
	...
	osg::ref_ptr<osg::Node> CreateBillboardLayer(BillboardLayer &layer, osg::Node* terrain)
	{
		osg::ref_ptr<osg::Group> layer_node = new osg::Group();
		BillboardLayerHelper::_PrepareStateSet(layer_node->getOrCreateStateSet(), layer);
