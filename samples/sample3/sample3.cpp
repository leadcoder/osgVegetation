...
int main( int argc, char **argv )
{
	...
	std::map<MaterialEnum,osgVegetation::CoverageColor> material_map;
	material_map[GRASS] = osgVegetation::CoverageColor(0,0,0,1);
	material_map[WOODS] = osgVegetation::CoverageColor(0,1,0,1);
	material_map[ROAD] = osgVegetation::CoverageColor(0,0,1,1);
	material_map[DIRT] = osgVegetation::CoverageColor(1,0,0,1);
