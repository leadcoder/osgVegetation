...
int main(int argc, char **argv)
{
	...
	MeshTileGeneratorConfig layer(10000, 5);
	MeshTypeConfig mesh_data1;
	mesh_data1.MeshLODs.push_back(MeshTypeConfig::MeshLODConfig("trees/fir01_l0.osg", osg::Vec4(0.0f, 0.0f, 100.0f, 110.0f)));
	mesh_data1.MeshLODs.push_back(MeshTypeConfig::MeshLODConfig("trees/fir01_l1.osg", osg::Vec4(100.0f, 110.0f, 2500.0f, 2510.0f)));
	...
	MeshTypeConfig  mesh_data2;
	mesh_data2.MeshLODs.push_back(MeshTypeConfig::MeshLODConfig("trees/test.osg", osg::Vec4(0.0f, 0.0f, 2000.0f, 2500.0f)));
	layer.MeshTypes.push_back(mesh_data2);

	std::vector<MeshTileGeneratorConfig> layers;
	layers.push_back(layer);

	osgDB::Registry::instance()->setReadFileCallback(new VegetationReadFileCallback(layers));
